...
> Filled during the specification interview (one item at a time). "Fill it in for me" = fill with a
> reasonable default, but mark it as a default. Order: put cheap rejections first — don't interview a dead idea to the end.

- **Topic**: <topic>
- **One-line framing**:
- **Why now**:
- **Goal** — what do you want to learn / build (observable):
- **Prior art (Gate-1)** ★early — is this already a closed question or an existing tool? Grade the delta:
